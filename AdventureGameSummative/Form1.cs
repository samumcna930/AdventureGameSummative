           ...
           switch (scene)

            {
                ...
                case 9: outputLabel.Text = "You come along to the river shore and can see many trout in swimming with the current.";
                    redlabel.Text = "catch the fishes";
                ...
                case 10:
                    ...
                    redlabel.Text = "loot the body";
                    bluelabel.Text = "Don't loot the body";
                    break;
                case 11:
                    outputLabel.Text = "You loot the dead man and find a rusty key.You also find a hunting knife.";
                    redlabel.Text = "go back to riverbed";
                    bluelabel.Text = "go back to hut";
                    break;
                case 12:
                    outputLabel.Text = "You are successful in catching some trout. ";
                    redlabel.Text = "Go back to hut";
                    bluelabel.Text = "Don't go back to the hut";
                    break;
                case 13:
                ...
                case 20:
                    ...
                    redlabel.Text = "shoot again";
                    bluelabel.Text = "Climb a tree";
                    break;
                case 21:
                    outputLabel.Text = "The bear is closing in on you";
                    redlabel.Text = "Take another shot";
                    bluelabel.Text = "Run";
                    break;
                case 22:
                ...
                case 28:
                    ...
                    redlabel.Text = "Shoot";
                    bluelabel.Text = "Throw fish";
                    greenlabel.Text = "Climb higher";
                    break;
                case 29:
                ...
                case 35:
                    ...
                    redlabel.Text = "Use the rusty key";
                    bluelabel.Text = "Return to hut";
